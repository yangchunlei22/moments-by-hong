...
const categories: Category[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: `${CDN}GpVWdzXBZRWZuhTT.jpeg`, alt: "Steinway & Sons concert venue setup" },
      { src: `${CDN}WfFEztjUHloBAUJo.jpeg`, alt: "Concert audience at Steinway & Sons" },
      { src: `${CDN}XprNJAnMCiHAyzuM.jpeg`, alt: "Steinway piano concert — performer close-up" },
      { src: `${CDN}YjUSzPcvVwQKopDv.jpeg`, alt: "Steinway concert — pianist at grand piano" },
      { src: `${CDN}nyyKPdzctBHxynYP.jpeg`, alt: "Pianist receiving flowers after concert" },
      { src: `${CDN}kqaoNNBiUleGZBUA.jpeg`, alt: "Steinway concert — post-performance celebration" },
      { src: `${CDN}MWfthEZjKNSIYcSX.jpeg`, alt: "Birthday party outdoor, safari theme" },
      { src: `${CDN}AIeywpcbgzrLMOcs.jpeg`, alt: "Birthday party outdoor event photography" },
      { src: `${CDN}IIIzfeAIMhsPjMZH.jpeg`, alt: "Outdoor birthday celebration" },
      { src: `${CDN}cEcvrlVjYSFsiyxv.jpeg`, alt: "Couple walking at City Hall, marriage registration" },
      { src: `${CDN}YxMTQOJCyKoadbYN.jpeg`, alt: "Marriage registration follow-along photography" },
      { src: `${CDN}CWXNPOLWDCTCImxp.jpeg`, alt: "Wedding couple kissing at San Francisco City Hall" },
      { src: `${CDN}GnjuLjVJIIoHUmXv.jpeg`, alt: "Wedding portrait at City Hall" },
    ],
  },
  {
    id: "tradition",
    ...
    images: [
      { src: `.https://imgur.com/Aov8qP4jpeg`, alt: "kelly" },
      { src: `..jpeg`, alt: "" },
      { src: `..jpeg`, alt: "" },
      { src: `..jpeg`, alt: "" },
      { src: `..jpeg`, alt: "" },
