...
const categories: Category[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: `https://imgur.com/aiotyV2`, alt: "Baby in red in rattan basket, Zhuazhou ceremony" },
      { src: `https://imgur.com/FX6Fzdq`, alt: "Harry Potter themed baby studio portrait" },
      { src: `https://imgur.com/ZG4fXB8`, alt: "Zhuazhou ceremony with Chinese cultural decor" },
      { src: `https://imgur.com/KXe0IAf`, alt: "Baby girl 1st birthday studio portrait" },
      { src: `https://imgur.com/2WMZy8D`, alt: "Baby 1st birthday portrait with cake smash" },
      { src: `https://imgur.com/WDud1DG`, alt: "Baby studio portrait with soft pink backdrop" },
      { src: `https://imgur.com/8r0ijKl`, alt: "Toddler 1st birthday studio session" },
      { src: `https://imgur.com/tBR1WTC`, alt: "Baby studio portrait with floral props" },
      { src: `https://imgur.com/jfC3ROA`, alt: "Baby milestone portrait session" },
      { src: `https://imgur.com/gLTWTsc`, alt: "Baby studio portrait, natural light" },
      { src: `https://imgur.com/aFbjE2D`, alt: "Baby 1st birthday studio portrait" },
      ...
      { src: `https://imgur.com/GnSrFrK`, alt: "Zhuazhou ceremony — outdoor green backdrop" },
      { src: `https://imgur.com/DLqlh2P`, alt: "Zhuazhou ceremony — baby with traditional items" },
      { src: `https://imgur.com/dS5pXs3`, alt: "Zhuazhou ceremony — family celebration" },
      { src: `https://imgur.com/xLH8Ch1`, alt: "Zhuazhou ceremony — baby reaching for items" },
    ],
  },
  {
    id: "lifestyle",
